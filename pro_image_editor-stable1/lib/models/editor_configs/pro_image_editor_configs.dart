...
import 'Adjust_editor_configs.dart';
...
class ProImageEditorConfigs {
  ...
  const ProImageEditorConfigs( {
    ...
    this.imageAdjustmentConfigs = const ImageAdjustmentConfigs(),
  ...
  /// Configuration options for the Adjust Editor
  final ImageAdjustmentConfigs imageAdjustmentConfigs;
