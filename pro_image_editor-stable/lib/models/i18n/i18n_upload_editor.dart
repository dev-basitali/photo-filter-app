...
class I18nUploadEditor {
  ...
  /// Creates an instance of [I18nUploaddEditor] with customizable internationalization settings.
  ///
  ...
  /// )
  /// ```
  const I18nUploadEditor({
    this.bottomNavigationBarText = 'Upload',
    this.back = 'Back',
    this.done = 'Done',
