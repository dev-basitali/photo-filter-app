...
class I18nCopyUrlEditor {
  ...
  /// Creates an instance of [I18nCopyUrlEditor] with customizable internationalization settings.
  ///
  /// You can provide translations and messages for various components of the
  /// Text Editor in the Image Editor. Customize the text for input fields, buttons,
  /// and settings to suit your application's language and style.
  ///
  /// Example:
  ///
  /// ```dart
  ...
  /// )
  /// ```
  const I18nCopyUrlEditor({
    this.bottomNavigationBarText = 'Copy URL',
    this.back = 'Back',
    this.done = 'Done',
