...
class IconsLayerInteraction {
  ...
  /// The [remove] icon defaults to [FontAwesomeIcons.times].
  /// The [rotateScale] icon defaults to [FontAwesomeIcons.arrowsAlt].
  const IconsLayerInteraction({
    this.remove = FontAwesomeIcons.times,
    this.edit = FontAwesomeIcons.penToSquare,
    this.rotateScale = FontAwesomeIcons.arrowsAlt,
  });
