...
import 'icons_copyurl_editor.dart';
...
import 'icons_upload_editor.dart';
...
class ImageEditorIcons {
  ...
  /// Icons for the upload Editor component.
  final IconsUploadEditor uploadEditor;

  /// Icons for the copy Url Editor component.
  final IconsCopyUrlEditor copyUrlEditor;
  ...
  const ImageEditorIcons({
    ...
    this.uploadEditor = const IconsUploadEditor(),
    this.copyUrlEditor = const IconsCopyUrlEditor(),
