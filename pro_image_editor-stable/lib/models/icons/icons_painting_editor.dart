...
class IconsPaintingEditor {
  ...
  const IconsPaintingEditor({
    this.moveAndZoom = FontAwesomeIcons.expandArrowsAlt,
    this.changeOpacity = FontAwesomeIcons.tint,
    ...
    this.noFill = FontAwesomeIcons.timesCircle,
    this.rectangle = FontAwesomeIcons.square,
    this.circle = FontAwesomeIcons.circle,
    this.dashLine = FontAwesomeIcons.ellipsisH,
  });
