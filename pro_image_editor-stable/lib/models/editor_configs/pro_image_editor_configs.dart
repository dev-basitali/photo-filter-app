...
import 'package:pro_image_editor/models/editor_configs/upload_editor_configs.dart';
...
import 'copyurl_editor_configs.dart';
...
class ProImageEditorConfigs {
  ...
  /// Configuration options for the Text Editor.
  final UploadEditorConfigs uploadEditorConfigs;

  /// Configuration options for the Text Editor.
  final CopyUrlEditorConfigs copyUrlEditorConfigs;
  ...
  const ProImageEditorConfigs({
    ...
    this.uploadEditorConfigs = const UploadEditorConfigs(),
    this.copyUrlEditorConfigs = const CopyUrlEditorConfigs(),
  });
}
