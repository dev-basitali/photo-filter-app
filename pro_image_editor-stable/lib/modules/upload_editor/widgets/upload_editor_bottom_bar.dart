...
class UploadEditorBottomBar extends StatefulWidget {
  ...
  @override
  State<UploadEditorBottomBar> createState() => _TextEditorBottomBarState();
}

class _TextEditorBottomBarState extends State<UploadEditorBottomBar> {
