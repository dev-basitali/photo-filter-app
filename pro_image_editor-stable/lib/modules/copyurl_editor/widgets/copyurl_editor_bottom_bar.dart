...
class CopyUrlEditorBottomBar extends StatefulWidget {
  ...
  @override
  State<CopyUrlEditorBottomBar> createState() => _TextEditorBottomBarState();
}

class _TextEditorBottomBarState extends State<CopyUrlEditorBottomBar> {
  ...
  Widget build(BuildContext context) {
    // if (widget.configs.UploadEditorConfigss == null) {
